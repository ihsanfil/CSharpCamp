...
namespace FinancialCrm
{
    public partial class FrmDashboard : Form
    {
        ...
        private void FrmDashboard_Load(object sender, EventArgs e)
        {
            ...
            var lastBankProcessAmout = db.BankProcesses.OrderByDescending(x => x.BankProcessId).Take(1).Select(x => x.Amount).FirstOrDefault();
            lblLastBankProcessAmount.Text = lastBankProcessAmout.ToString() + " ₺";
